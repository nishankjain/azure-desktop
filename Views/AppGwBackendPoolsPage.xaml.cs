...
public sealed partial class AppGwBackendPoolsPage : Page
{
    private const AppGwSection Section = AppGwSection.BackendPools;
    ...
    private void OnItemClick(object? sender, string name)
    {
        ...
        Frame.Navigate(typeof(AppGwBackendPoolDetailPage), _navCtx with { DetailItemName = name });
    }
